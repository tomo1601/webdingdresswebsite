        ...
        if (session.getAttribute("email") == null) {
            ...
            if (!listDetailCart.isEmpty()) {
                ...
                for (DetailCart item : listDetailCart) {
                    detailCartNew.setDetailCartPK(item.getDetailCartPK());
                ...
                DetailCartPK detailCartPKNew = new DetailCartPK();
                detailCartPKNew.setIDCart(cartNew.getIDCart());
                detailCartPKNew.setIDProd(iDProd);

                DetailCart detailCartNew = new DetailCart();
                detailCartNew.setDetailCartPK(detailCartPKNew);
            ...
            for (Cart item : listCart) {
                cartNew.setIDCart(item.getIDCart());
                cartNew.setMailClient(item.getMailClient());
